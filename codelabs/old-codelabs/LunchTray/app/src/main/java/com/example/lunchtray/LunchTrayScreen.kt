...
enum class LunchTrayScreen(@StringRes val title: Int) {
    StartOrder(R.string.start_order),
    EntreeMenu(R.string.choose_entree),
    SideDishMenu(R.string.choose_side_dish),
    AccompaniamentMenu(R.string.choose_accompaniment),
        ...
        NavHost(
            ...
            composable(route = LunchTrayScreen.SideDishMenu.name) {
                SideDishMenuScreen(
                    ...
                    onNextButtonClicked = {
                        navController.navigate(LunchTrayScreen.AccompaniamentMenu.name)
                    },
                    onSelectionChanged = {
            ...
            composable(route = LunchTrayScreen.AccompaniamentMenu.name) {
...
private fun resetOrderAndPopToRoot(
